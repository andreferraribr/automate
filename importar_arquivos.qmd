...
criterios_saude <- list(
  ...
  `EXCETO ASPS - 301 - Despesas Correntes - Transferências` = list(
  ...
  `EXCETO ASPS - 301 - Demais Despesas` = list(
  ...
  `ASPS - 301 - Despesas de Capital - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 301 - Despesas de Capital - Demais Despesas` = list(
  ...
  `ASPS - 302 - Despesas Correntes - Demais Despesas` = list(
  ...
  `ASPS - 302 - Despesas de Capital - Demais Despesas` = list(
  ...
  # Adicionando os EXCETO que faltavam para 302
  `EXCETO ASPS - ASSISTÊNCIA HOSPITALAR E AMBULATORIAL - 302` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & iduso_codigo %notin% c(6)"
  ),
  
  `EXCETO ASPS - 302 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6)"
  ),
  
  `EXCETO ASPS - 302 - Despesas Correntes - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 302 - Despesas Correntes - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 302 - Despesas de Capital` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6)"
  ),
  
  `EXCETO ASPS - 302 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 302 - Despesas de Capital - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('302') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # SUPORTE PROFILÁTICO E TERAPÊUTICO - 303
  `ASPS - SUPORTE PROFILÁTICO E TERAPÊUTICO - 303` = list(
    criterio = "subfuncao_governo_codigo %in% c('303') & iduso_codigo %in% c(6)"
  ),
  
  `EXCETO ASPS - SUPORTE PROFILÁTICO E TERAPÊUTICO - 303` = list(
    criterio = "subfuncao_governo_codigo %in% c('303') & iduso_codigo %notin% c(6)"
  ),
  
  # 303 - Despesas Correntes
  `ASPS - 303 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('303') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(1, 2, 3)"
  ),
  
  `EXCETO ASPS - 303 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('303') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6)"
  ),
  
  `ASPS - 303 - Despesas Correntes - Transferências` = list(
  ...
  `ASPS - 303 - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 303 - Despesas Correntes - Demais Despesas` = list(
  ...
  `ASPS - 303 - Despesas de Capital - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 303 - Despesas de Capital - Demais Despesas` = list(
  ...
  `ASPS - 304 - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 304 - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 304 - Despesas de Capital - Demais Despesas` = list(
  ...
  # Adicionando a linha que faltava para 304
  `EXCETO ASPS - 304 - Despesas Correntes - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('304') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - 304 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('304') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 304 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('304') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # VIGILÂNCIA EPIDEMIOLÓGICA - 305
  `ASPS - VIGILÂNCIA EPIDEMIOLÓGICA - 305` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & iduso_codigo %in% c(6)"
  ),
  
  `EXCETO ASPS - VIGILÂNCIA EPIDEMIOLÓGICA - 305` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & iduso_codigo %notin% c(6)"
  ),
  
  # 305 - Despesas Correntes
  `ASPS - 305 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(1, 2, 3)"
  ),
  
  `EXCETO ASPS - 305 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6)"
  ),
  
  `ASPS - 305 - Despesas Correntes - Transferências` = list(
  ...
  `EXCETO ASPS - 305 - Despesas Correntes - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - 305 - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 305 - Despesas Correntes - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # 305 - Despesas de Capital
  `ASPS - 305 - Despesas de Capital` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(4, 5, 6)"
  ),
  
  `EXCETO ASPS - 305 - Despesas de Capital` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6)"
  ),
  
  `ASPS - 305 - Despesas de Capital - Transferências` = list(
  ...
  `EXCETO ASPS - 305 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - 305 - Despesas de Capital - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 305 - Despesas de Capital - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('305') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # ALIMENTAÇÃO E NUTRIÇÃO - 306
  `ASPS - ALIMENTAÇÃO E NUTRIÇÃO - 306` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %in% c(6)"
  ),
  
  `EXCETO ASPS - ALIMENTAÇÃO E NUTRIÇÃO - 306` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %notin% c(6)"
  ),
  
  # 306 - Despesas Correntes
  `ASPS - 306 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(1, 2, 3)"
  ),
  
  `EXCETO ASPS - 306 - Despesas Correntes` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6)"
  ),
  
  `ASPS - 306 - Despesas Correntes - Transferências` = list(
  ...
  `EXCETO ASPS - 306 - Despesas Correntes - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - 306 - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - 306 - Despesas Correntes - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # 306 - Despesas de Capital
  `ASPS - 306 - Despesas de Capital` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(4, 5, 6)"
  ),
  
  `EXCETO ASPS - 306 - Despesas de Capital` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6)"
  ),
  
  `ASPS - 306 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 306 - Despesas de Capital - Transferências` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - 306 - Despesas de Capital - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & iduso_codigo %in% c(6) & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `EXCETO ASPS - 306 - Despesas de Capital - Demais Despesas` = list(
    criterio = "subfuncao_governo_codigo %in% c('306') & grupo_despesa_codigo_grupo %in% c(4, 5, 6) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %notin% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  # OUTRAS SUBFUNÇÕES
  `ASPS - OUTRAS SUBFUNÇÕES` = list(
    criterio = "subfuncao_governo_codigo %notin% c('306', '305', '304', '303', '302', '301', '999') & iduso_codigo %in% c(6)"
  ),
  
  `EXCETO ASPS - OUTRAS SUBFUNÇÕES` = list(
    criterio = "subfuncao_governo_codigo %notin% c('306', '305', '304', '303', '302', '301', '999') & iduso_codigo %notin% c(6)"
  ),
  
  # OUTRAS - Despesas Correntes
  `ASPS - OUTRAS - Despesas Correntes` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas Correntes` = list(
  ...
  `ASPS - OUTRAS - Despesas Correntes - Transferências` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas Correntes - Transferências` = list(
    criterio = "subfuncao_governo_codigo %notin% c('306', '305', '304', '303', '302', '301', '999') & grupo_despesa_codigo_grupo %in% c(1, 2, 3) & iduso_codigo %notin% c(6) & modalidade_aplicacao_codigo %in% c('30', '31', '32', '35', '36', '40', '41', '42', '45', '46')"
  ),
  
  `ASPS - OUTRAS - Despesas Correntes - Demais Despesas` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas Correntes - Demais Despesas` = list(
  ...
  `ASPS - OUTRAS - Despesas de Capital` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas de Capital` = list(
  ...
  `ASPS - OUTRAS - Despesas de Capital - Transferências` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas de Capital - Transferências` = list(
  ...
  `ASPS - OUTRAS - Despesas de Capital - Demais Despesas` = list(
  ...
  `EXCETO ASPS - OUTRAS - Despesas de Capital - Demais Despesas` = list(
  ...
  `ASPS - RESERVA DE CONTINGÊNCIA - 999` = list(
    criterio = "subfuncao_governo_codigo %in% c('999') & iduso_codigo %in% c(6)"
  ),
  
  `EXCETO ASPS - RESERVA DE CONTINGÊNCIA - 999` = list(
    criterio = "subfuncao_governo_codigo %in% c('999') & iduso_codigo %notin% c(6)"
  ),
  
  # OUTRAS LINHAS
  `Ações Não Computadas (Inativos e Pensionistas + Ñ Acesso Universal + Outras Ações)` = list(
  ...
  `Conferência (Iduso 6)` = list(
    criterio = "iduso_codigo %in% c(6)"
  ),
  
  `Conferência (ASPS e demais despesas)` = list(
    criterio = "iduso_codigo %in% c(6) | iduso_codigo %notin% c(6)"
  ),
  
  `Conferência 2 (Iduso 6 sem 42)` = list(
    criterio = "iduso_codigo %in% c(6) & fonte_recursos_codigo %notin% c('42', '008', '035')"
  ),
  
  `Conferência 3 (Fonte 42 para Iduso 6)` = list(
    criterio = "iduso_codigo %in% c(6) & fonte_recursos_codigo %in% c('42', '035', '008')"
  ),
  
  `Conferência 4 (Fonte 42 exceto Iduso 6)` = list(
    criterio = "fonte_recursos_codigo %in% c('008', '042', '035', '242') & iduso_codigo %notin% c(6)"
  )
...
DT_anexo_12 <- anexo_12 %>% 
  filter(mes_lancamento == "ABR/2025") %>%
  group_by(ordem, categoria, item_informacao_nome) %>% 
  summarise(saldo = sum(saldo_r_item_informacao, na.rm = TRUE), .groups = "drop") %>%
  complete(categoria, item_informacao_nome, fill = list(saldo = 0)) %>%
  pivot_wider(names_from = item_informacao_nome, values_from = saldo)
