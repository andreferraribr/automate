...
criterios_receitas_anexo3_rcl <- list(
  ...
  # CONTRIBUIÇÕES PARA PIS/PASEP - CRITÉRIO ESPECÍFICO
  `10  Contribuições para PIS/PASEP` = list(
    ...
    observacao = "Critério focado APENAS nas contribuições PIS/PASEP e fontes específicas",
    status = "✅ VALIDADO - Apenas PIS/PASEP"
  ),
  
  # DEDUÇÕES - CRITÉRIO SIMPLIFICADO COM CORREÇÃO ESPECÍFICA
  
  # DEDUÇÕES
# Estruturas hierárquicas múltiplas baseadas na classificação orçamentária:
# - PIS/PASEP: 1.2.1.2 (Receitas Correntes > Contribuições > Contribuições Sociais > PIS/PASEP)
#   Fontes: 031 (FUNDAF-PGFN), 032 (FUNDAF-RFB), 040 (Seguro-Desemprego), 041 (Desenvolvimento Econômico)
# - RGPS: 1.2.1.4 (Receitas Correntes > Contribuições > Contribuições Sociais > RGPS)
#   Fontes: 054 (Benefícios do RGPS) - maior volume de deduções
# - RPPS: 1.2.1.5 (Receitas Correntes > Contribuições > Contribuições Sociais > RPPS)
#   Fontes: 023 (Pensões Militares), 032 (FUNDAF-RFB), 055 (RPPS FCDF), 056 (RPPS União)
# - Outras Contribuições: 1.2.1.9 (Receitas Correntes > Contribuições > Contribuições Sociais > Outras)
#   Fontes: 054 (Benefícios do RGPS)
# - Multas Administrativas: 1.9.1.1 (Outras Correntes > Multas > Administrativas)
#   Fontes: 054 (Benefícios do RGPS)
# - Restituições: 1.9.2.2 (Outras Correntes > Indenizações/Restituições > Restituições)
#   Fontes: 040 (Seguro-Desemprego), 054 (Benefícios do RGPS), 056 (RPPS União)
# - Ressarcimentos: 1.9.2.3 (Outras Correntes > Indenizações/Restituições > Ressarcimentos)
#   Fontes: 054 (Benefícios do RGPS)
# - Demais Receitas: 1.9.9.9 (Outras Correntes > Demais Receitas > Outras Diversas)
#   Fontes: 054 (Benefícios do RGPS)
# Total: 77 registros únicos fonte-natureza | R$ 327,74 bilhões em deduções
  ...
  (grepl('^1999', natureza_receita_codigo_completo) & fonte_recursos_codigo == '054')
    ...
    correcao_aplicada = "Adicionada condição específica: fonte 032 + natureza 12150116",
    
    observacao = "Critério anterior mantido + correção pontual para capturar CONTRIBUIÇÃO DO SERVIDOR CIVIL ATIVO-JUROS",
    item_informacao = "Item Informação será aplicado diretamente no código principal",
    status = "✅ CORRIGIDO - Adicionada condição específica para fonte 032 + natureza 12150116"
  )
)
```
...
datatable(DT_teste )%>%
  formatRound(which(sapply(DT_teste, is.numeric)), 2, mark = ".", dec.mark = ",")
```
...
```{r}
datatable(dados_receita %>% filter(
    
(nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 2 & nre3_especie_receita_codigo_especie == 1 & nre4_desdobramento_codigo_desdobramento_1 == 2 & fonte_recursos_codigo %in% c('031', '032', '040', '041')) |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 2 & nre3_especie_receita_codigo_especie == 1 & nre4_desdobramento_codigo_desdobramento_1 == 4 & fonte_recursos_codigo == '054') |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 2 & nre3_especie_receita_codigo_especie == 1 & nre4_desdobramento_codigo_desdobramento_1 == 5 & fonte_recursos_codigo %in% c('023', '032', '055', '056')) |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 2 & nre3_especie_receita_codigo_especie == 1 & nre4_desdobramento_codigo_desdobramento_1 == 9 & fonte_recursos_codigo == '054') |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 9 & nre3_especie_receita_codigo_especie == 1 & nre4_desdobramento_codigo_desdobramento_1 == 1 & fonte_recursos_codigo == '054') |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 9 & nre3_especie_receita_codigo_especie == 2 & nre4_desdobramento_codigo_desdobramento_1 == 2 & fonte_recursos_codigo %in% c('040', '054', '056')) |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 9 & nre3_especie_receita_codigo_especie == 2 & nre4_desdobramento_codigo_desdobramento_1 == 3 & fonte_recursos_codigo == '054') |
  (nre1_categoria_economica_codigo == 1 & nre2_origem_receita_codigo_origem == 9 & nre3_especie_receita_codigo_especie == 9 & nre4_desdobramento_codigo_desdobramento_1 == 9 & fonte_recursos_codigo == '054'),
...
```{r}
deducao_r <-  dados_receita %>% filter(
    
(fonte_recursos_codigo == '023' & natureza_receita_codigo_completo %in% c('12150411', '12150412')) |
  (fonte_recursos_codigo == '031' & natureza_receita_codigo_completo %in% c('12120108', '12120208', '12124908')) |
  (fonte_recursos_codigo == '032' & natureza_receita_codigo_completo %in% c('12120106', '12120206', '12124906', '12150116')) |
  (fonte_recursos_codigo == '040' & natureza_receita_codigo_completo %in% c('12120101', '12120103', '12120105', '12120107', '12120201', '12120203', '12120205', '12120207', '12124901', '12124903', '12124905', '12124907', '19220701', '19220702')) |
  (fonte_recursos_codigo == '041' & natureza_receita_codigo_completo %in% c('12120101', '12120103', '12120105', '12120107', '12120201', '12120203', '12120205', '12120207', '12124901', '12124903', '12124905', '12124907')) |
  (fonte_recursos_codigo == '054' & natureza_receita_codigo_completo %in% c('12140111', '12140112', '12140113', '12140114', '12140121', '12140122', '12140123', '12140124', '12140201', '12140202', '12140203', '12140204', '12144901', '12144902', '12144903', '12144904', '12199911', '19110103', '19111101', '19111102', '19220301', '19220302', '19220303', '19220631', '19220632', '19230401', '19230402', '19990301', '19990302', '19990303', '19999914')) |
  (fonte_recursos_codigo == '055' & natureza_receita_codigo_completo %in% c('12150111', '12150121')) |
  (fonte_recursos_codigo == '056' & natureza_receita_codigo_completo %in% c('12150111', '12150113', '12150115', '12150121', '12150131', '12150141', '12150151', '12150161', '19220631')),
      item_informacao_codigo == 5
) %>% group_by(fonte_recursos_codigo, natureza_receita_codigo_completo)
  summarise(saldo_r_item_informacao = sum(saldo_r_item_informacao))
  
  write.csv(deducao_r, "deducao_r.csv")
