...
dcl_p1 <- (aplicar_criterios(dcl_1, criterios_rgf_A02_dcl_1))

dcl_p2 <- (aplicar_criterios(dcl_2a, criterios_rgf_A02_dcl_2a))

dcl_p3 <- (aplicar_criterios(dcl_2b, criterios_rgf_A02_dcl_2b))


dcl_p4 <-  rbind(dcl_p1, dcl_p2)

dcl_p4 <- rbind(dcl_p3, dcl_p4)

datatable(dcl_p4 %>% group_by(ordem, nome) %>% summarise(valor = sum(valor)))
...
```{r}
criterios_consolidados_clean <- read_csv("data/202509/criterios_consolidados_clean.csv")
```
