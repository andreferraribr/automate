...
```{r}
# CRITÉRIOS RGF ANEXO 1 - DESPESA COM PESSOAL (ESTRUTURA HIERÁRQUICA CORRETA)
# ===============================================================================
...
`02  Vencimentos, Vantagens e Outras Despesas Variáveis` = list(
  criterio = "
  # BASE: Grupo Despesa = 1 (PESSOAL E ENCARGOS SOCIAIS)
  grupo_despesa_codigo_grupo == '1' &
  
  # EXCLUSÃO NÍVEL 1: Elemento Despesa NOT IN (01:APOSENT.RPPS, RESER.REMUNER. E REFOR.MILITAR, 03:PENSOES DO RPPS E DO MILITAR, 34:OUTRAS DESPESAS DE PESSOAL - TERCEIRIZACAO)
  !elemento_despesa_codigo %in% c('01', '03', '34') &
  
  # EXCLUSÃO NÍVEL 1: Filtro Obrigações Patronais vg2024 (AND NOT)
  !(grupo_despesa_codigo_grupo == '1' & elemento_despesa_codigo %in% c('13', '07')) &
  
  # EXCLUSÃO NÍVEL 1: Filtro Pessoal ATIVO - Benefícios Previdenciários v2024 (AND NOT)
  !(grupo_despesa_codigo_grupo == '1' & str_detect(natureza_despesa_detalhada_codigo, '0599')) &
  
  # EXCLUSÃO NÍVEL 1: Filtro - Anexo 1 - Termos de Outros Inativos vg2024 (AND NOT)
  !str_detect(natureza_despesa_detalhada_nome, 'APOSENT|INAT|REFORMA|PEN|LEI 7.963/1989') &
  
  # EXCLUSÃO NÍVEL 2 (DENTRO DE TERMOS INATIVOS): Filtro - Anexo 1 - Elementos de Despesa de Outros Inativos vg2024 (AND NOT)
  ...
  # EXCLUSÃO NÍVEL 2 (DENTRO DE ELEMENTOS INATIVOS): Filtro Pessoal INATIVO - Benefícios Previdenciários vg2024 (AND NOT)
  !(str_detect(natureza_despesa_detalhada_nome, 'APOSENT|INAT|REFORMA|PEN|LEI 7.963/1989') & elemento_despesa_codigo %in% c('05', '08', '09', '17', '31', '32') & elemento_despesa_codigo == '05' & (str_detect(natureza_despesa_detalhada_codigo, '0505') | str_detect(natureza_despesa_detalhada_codigo, '0506') | str_detect(natureza_despesa_detalhada_codigo, '0507') | str_detect(natureza_despesa_detalhada_codigo, '0508')))
  "
),
  ...
  `10  Decorrentes de Decisão Judicial` = list(
    ...
    # INCLUSÃO: Elemento Despesa = 91 (SENTENÇAS JUDICIAIS)
    elemento_despesa_codigo == '91' &
    
    # EXCLUSÃO NÍVEL 1: Filtro - Anexo 1 - Termos de Outros Inativos vg2024 (AND NOT)
    !str_detect(natureza_despesa_detalhada_nome, 'APOSENT|INAT|REFORMA|PEN|LEI 7.963/1989') &
    
    # EXCLUSÃO NÍVEL 1: Filtro - Anexo 1 - Fontes dos Recursos Vinculados vg2024 (AND NOT)
    !fonte_recursos_codigo %in% c('023', '024', '055', '056', '069')
    "
  ),
  ...
  `11  Inativos e Pensionistas com Recursos Vinculados` = list(
    ...
    # INCLUSÃO NÍVEL 1: Filtro - Anexo 1 - Fontes dos Recursos Vinculados vg2024
    fonte_recursos_codigo %in% c('023', '024', '055', '056', '069') &
    
    # INCLUSÃO: Elemento Despesa = 01 ou 03 (APOSENTADORIAS e PENSÕES)
    elemento_despesa_codigo %in% c('01', '03') &
    
    # EXCLUSÃO NÍVEL 2 (DENTRO DE FONTES): Filtro - Anexo 1 - Elementos de Despesa de Outros Inativos vg2024 (AND NOT)
    !elemento_despesa_codigo %in% c('05', '08', '09', '17', '31', '32') &
    
    # EXCLUSÃO NÍVEL 2 (DENTRO DE FONTES): Filtro - Anexo 1 - Termos de Outros Inativos vg2024 (AND NOT)
    !str_detect(natureza_despesa_detalhada_nome, 'APOSENT|INAT|REFORMA|PEN|LEI 7.963/1989')
    "
  ),
  ...
  `12  Indenizações por Demissão e Incentivos` = list(
    ...
    # INCLUSÃO: Elemento Despesa = 94 (INDENIZAÇÕES E RESTITUIÇÕES TRABALHISTAS)
  ...
  `13  Despesas de Exercícios Anteriores` = list(
    ...
    # INCLUSÃO: Elemento Despesa = 92 (DESPESAS DE EXERCÍCIOS ANTERIORES)
