...
criterios_rreo_A03_rcl_despesas <- list(
...
datatable(aplicar_criterios(df = dados_despesa %>% unique(), criterios_rreo_A03_rcl_despesas))
```
...
criterios_rreo_A03_rcl_rpcancelados <- list(
...
datatable(aplicar_criterios(df = dados_rp_anexo_03_rcl %>% unique(), criterios_rreo_A03_rcl_rpcancelados))
```
...
criterios_rreo_A04_rgps_receitas <- list(
...
criterios_rreo_A04_rgps_despesas <- list(
...
datatable(aplicar_criterios(df = dados_receita %>% 
    filter(
      ...
      natureza_receita_codigo_completo == 79900211), criterios_rreo_A04_rgps_receitas))
...
datatable(aplicar_criterios(df = dados_despesa %>% 
    filter(unidade_orcamentaria_codigo %in% c(33904, 40904, 55902, 25917)), criterios_rreo_A04_rgps_despesas))
...
criterios_rreo_A04_rpps_receitas_civil_militar <- list(
...
criterios_rreo_A04_rpps_despesas_civil_militar <- list(
...
datatable(aplicar_criterios(df = dados_receita %>% 
    ...
    ), criterios_rreo_A04_rpps_receitas_civil_militar))
...
datatable(aplicar_criterios(df = dados_despesa %>% 
    ...
    ), criterios_rreo_A04_rpps_despesas_civil_militar))
...
# ===============================================================================
criterios_rreo_A06_receitas <- list(
...
# ===============================================================================
criterios_rreo_A06_despesas_categoria_grupo <- list(
...
# ===============================================================================
criterios_rreo_A06_despesas_natureza_detalhada <- list(
...
# ===============================================================================
criterios_rreo_A06_transferencias_subsidios <- list(
...
# ===============================================================================
criterios_rreo_A06_disponibilidades <- list(
...
# ===============================================================================
criterios_rreo_A06_juros_ativos_passivos <- list(
