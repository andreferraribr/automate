...
```{r anexo_06_rreo_despesas}

# RREO ANEXO 6 - DESPESAS PRIMÁRIAS - CÓDIGO SIMPLIFICADO
# Aplica filtros diretos nas DataFrames
...
# =============================================================================
# FUNÇÃO SIMPLIFICADA PARA DESPESAS PRIMÁRIAS RREO
# =============================================================================
...
despesas_primarias_rreo <- function(dados_ndd, dados_categoria_grupo) {
    ...
    # Filtrar dados_ndd
    dados_ndd <- dados_ndd %>%
        filter(!acao_governo_codigo %in% acoes_excluidas,
...
```{r}
datatable(dados_categoria_grupo %>% filter(categoria_economica_despesa_codigo == 4) %>% group_by(mes_lancamento) %>% summarise(saldo_r_conta_contabil = sum(saldo_r_conta_contabil, na.rm = TRUE)))
```
