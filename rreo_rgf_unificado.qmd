...
# Ver resumo de todos os critérios
# resumir_criterios(criterios_relatorios_fiscais)

# Ver todos os relatórios
# listar_relatorios(criterios_relatorios_fiscais)

# Ver anexos do RREO
# listar_anexos(criterios_relatorios_fiscais, "RREO")

# Aplicar só critérios do RREO
# resultado_rreo <- aplicar_criterios(dados_despesa, criterios_relatorios_fiscais, filtro_relatorio = "RREO")

# Aplicar só critérios do Anexo 3 (RCL)
# resultado_rcl <- aplicar_criterios(dados_receita, criterios_relatorios_fiscais, filtro_anexo = "A03")

# Converter uma lista antiga
# nova_estrutura <- converter_lista_antiga(
#   criterios_despesas_anexo3_rcl, 
#   relatorio = "RREO", 
#   anexo_nome = "RCL", 
#   anexo_codigo = "A03", 
#   base_dados = "dados_despesa"
# )
...
# Aplicar só critérios do RREO
# resultado_rreo <- aplicar_criterios(dados, criterios_relatorios_fiscais, filtro_relatorio = "RREO")

# Aplicar só critérios do Anexo 3 (RCL)
# resultado_rcl <- aplicar_criterios(dados, criterios_relatorios_fiscais, filtro_anexo = "A03")
```
