...
# 📋 RREO Anexo 03 - RCL {#sec-anexo-07}
...
criterios_despesas_rpps <- list(
  ...
  `07  MILITARES - DESPESAS - A Detalhar Inativos` = list(
  ...
  `08  MILITARES - DESPESAS - Inativos` = list(
    criterio = "grupo_despesa_codigo_grupo %in% c(1) & elemento_despesa_codigo %in% c('01') & acao_governo_codigo %in% c('214H', '218K')"
  ),
  
  # MILITARES - DESPESAS - Outros Benefícios
  `09  MILITARES - DESPESAS - Outros Benefícios` = list(
    criterio = "acao_governo_codigo %in% c('214H', '218K', '0179', '000Q') & elemento_despesa_codigo %notin% c('00', '01', '03') & grupo_despesa_codigo_grupo %in% c(1)"
  )
)
```
