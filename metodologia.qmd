...
filtros_dados <- as.data.frame(colnames(filtros_anexo_01_despesa %>% clean_names()))
names(filtros_dados)[1] ="atributo_clean"

datatable(filtros_metodologia %>% filter(atributo_clean %notin% filtros_dados$atributo_clean & dimensao == "despesa"  ) )
