...
tabela_04_wide <- resultado_tabela_04 %>%
...
tabela_04_clean <- tabela_04_wide %>%
  mutate(
    disponibilidade_bruta_clean = case_when(
...
# ===============================================================================
# ETAPA 9: VISUALIZAR RESULTADO
# ===============================================================================

cat("\n=== TABELA 04 - RESULTADO FINAL ===\n")
print(tabela_04_final, n = Inf)

# Formatado em milhões
tabela_04_formatada <- tabela_04_final %>% filter(linhas != "outros") %>% adorn_totals("row") %>%
  mutate(
    across(
...
cat("\n=== TABELA 04 - FORMATADA (R$ Milhões) ===\n")
print(tabela_04_formatada, n = Inf)
...
write_xlsx(
  list(
    "Tabela_04_Final" = tabela_04_final,
    "Tabela_04_Milhoes" = tabela_04_formatada
  ),
  path = "rgf_tabela_04_final.xlsx"
)

cat("\n✅ Processamento concluído com sucesso!\n")
cat("📊 Arquivo exportado: rgf_tabela_04_final.xlsx\n")

# ===============================================================================
# VALIDAÇÃO: COMPARAR COM VALORES OFICIAIS
# ===============================================================================

cat("\n=== VALIDAÇÃO: LINHA EDUCAÇÃO ===\n")
tabela_04_formatada %>%
  filter(linhas == "1_educacao") %>%
  select(-mes_lancamento) %>%
  glimpse()

cat("\nValores Oficiais Educação:\n")
cat("Disp. Inicial: 37.999.587.565\n")
cat("Receitas: 20.253.777.870\n")
cat("Despesas: 11.956.266.750\n")
cat("Demais Fluxos: 20.574.099\n")
cat("Disp. Bruta: 46.276.524.587\n")
cat("Disp. Antes RP: 44.588.522.729\n")
```
